    ...
    <div class="row">
        <div class="col-lg-7">
            <div class="header-text">
                ...
                <h4><em>Browse</em> Our Popular Video Here</h4>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-sm-6">
                                <div class="item inner-item">
                                    <img src="{{asset('assets/images/popular-05.jpg')}}" alt="">
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="item">
                                    <img src="{{asset('assets/images/popular-06.jpg')}}" alt="">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="item">
                        <img src="{{asset('assets/images/popular-07.jpg')}}" alt="">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="item">
                        <img src="{{asset('assets/images/popular-08.jpg')}}" alt="">
